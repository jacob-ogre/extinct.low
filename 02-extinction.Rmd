...
\* _Appropriately, PEP uses "?" to denote that they are not declaring species extinct or that there is uncertainty._
...
This list of likely extinct species does not include species that are extinct in the wild. Even though we do not include those species in the tally, we note that these often number just a few individuals in propagation or captivity--very close to complete extinction. We identified `r length(ext_wild[[1]])` such species in our scans - _`r paste(ext_wild[[1]], collapse=", ")`_ - but the number is likely higher. For example, the PEP data indicated 14 Hawaiian plants that are extinct in the wild.

## Causes of extinction

The causes of extinction may be complex, often with no single mechanism responsible for the loss of a species. The Passenger Pigeon is a well-known example of this [complexity](http://www.audubon.org/magazine/may-june-2014/why-passenger-pigeon-went-extinct): rather than being lost solely to hunting, or solely to habitat loss, the species was likely lost through a combination of those factors plus an interaction with the species' social behavior. We anticipate this complexity is common and _determining_ the cause of extinction requires extensive data to critically evaluate. With often scant published information, we unfortunately can't determine the causes of extinction of all `r n_ext` species identified above. However, during the course of this project, we noticed three basic categories of causes\*:

<div id="cause_list">
1. _Invasive species_\*\* were the factor we noticed most commonly for extinction, driven by the _Achatinella_ snails and Hawaiian plants. The culprits include feral hogs, predatory snails, avian malaria, and a multitude of plants. Regardless the mechanism by which the invasives affected the listed species--trampling, predation, disease, competition--the end result was the same: species driven to extinction, or so compromised that they became susceptible to factors such as natural "accidents."

2. _Natural accidents_ were a surprisingly common theme in the narratives of extinction. _Hibiscadelphus woodii_, for example, was only ever known from four plants, three of which were taken out by a rockslide and the fourth died some years later. (Efforts were made to propagate the species, but were unsuccessful.) Several plants are believed to have been lost to Hurricane Iniki in 1992, including _Dubautia kenwoodii_. These sorts of natural accidents (and other stochastic events) are the reason why small population size is considered a significant extinction risk, for example, under the [five listing factors of the ESA](http://www.nmfs.noaa.gov/pr/listing/). We are unable to determine the extent to which invasive species or "unnatural processes" increased the susceptibility to natural accidents, but those situations seem likely.

3. _"Unnatural processes"_ were characteristic for some of the commonly recognized species on the list, like the eastern cougar and the Eskimo Curlew, which almost certainly fell victim to overharvest. Others, like the Maryland darter and Bachman's Warbler, most likely fell victim to anthropogenic habitat destruction and degradation. Similarly, several mussels in the Southeast we likely driven to extinction by a combination of abiotic habitat modification such as silt and pollution and (perhaps) biotic changes such as loss of fish hosts. Even though these types of processes were likely responsible for some extinctions, what stood out was how they have been relatively infrequent.
</div>

\* We do not include counts of the number of species for each category because the available information is too spotty to ensure the counts are accurate. For example, if a document doesn't mention accidents as part of a species' demise, does it mean they weren't responsible or was it just not important enough to mention? Rather than inviting problems by presenting numbers that may be biased, we simply describe the categories.

\*\* Most invasives arrive by human transport, but we separate this cause from the "unnatural processes" of point 3 because the threat is generally not active act like those processes. Additionally, invasive species may be an ultimate cause even when the proximate cause of loss is a natural accident.

<div class="aside-box">
In addition to the data mining to find likely extinct species and the basic categorization of causes of extinction, we performed three simple analyses about where and why species have been lost. We chose not to include them in the main body of the analyses for two reasons. First, the available data are incomplete for many species and attempting to fill in the blanks is beyond the scope of the present contribution. Second, the very high concentration of extinct species from Hawaii means the geographic and threats analyses are overwhelmed by that signal. For completeness, however, we include those analyses in the [Appendices](#appendices).
</div>

## Conclusion

Our analysis points to two broad conclusions. First, the community that works on and defends the ESA should not continue using the "99% effective" phrase to discuss the law's success: the data indicate the number is likely closer to 95%. Second, the community should discuss causes of extinction--and likely the common threats to extant listed species--in proportion to their frequency and importance, which doesn't seem ...not sure where this is going...
