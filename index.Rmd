...
labels <- sprintf(
  "<strong>%s</strong><br/>%g listed species<br/>%g pct. 'extinct'",
  states$NAME10, states$n_species, 100*round(states$pct_ext, 4)
) %>% lapply(htmltools::HTML)
